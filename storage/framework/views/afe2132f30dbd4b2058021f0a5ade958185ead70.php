...
<?php $__env->startSection('breadcrumbs-list'); ?>
	...
	<li class="breadcrumb-item active" aria-current="page"> <?php echo e(__($campuses->name_translation)); ?> </li>
<?php $__env->stopSection(); ?>
...
<h4 class="text-center"><?php echo e(__($campuses->name_translation)); ?></h4> 

<div class="news-content">
    <p><?php echo __($campuses->content_translation); ?></p>
</div>
