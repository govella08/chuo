<div class="content">
    ...
    <?php endif; ?>
      ...
      <div class="content active" id="panel1">
		...
		<div class="row collapse">
			<div class="large-12 columns">
				...
				<?php echo Form::textarea('summary', null, ['id' => 'redactor_sw', 'class' => 'text-area-medium']); ?>
      ...
      <div class="content" id="panel2">
		...
		<div class="row collapse">
			<div class="large-12 columns">
				...
				<?php echo Form::textarea('summary_en', null, ['id' => 'redactor_en', 'class' => 'text-area-medium']); ?>
      ...
      <div class="row collapse">
			<div class="large-12 columns">
				<?php echo Form::label('photo_url', 'Photo'); ?>
