...
<div class="row collapse">
				...
				<table>
					...
					<tbody>
						...
						<tr>
							...
							<td>
								<?php echo link_to_route('cms.quick_links.destroy', "", array($link->id), array('data-method' => 'delete', 'data-confirm' => 'Are you Sure' ,'class' => 'ion ion-android-delete item-delete')); ?>

								<a href="<?php echo e(URL::route('cms.quick_links.edit', $link->id)); ?>" class="item-edit">Edit</a>
							</td>
						</tr>
	...
	<div class="large-6 columns medium-12 small-12 columns">
		<div class="content-panel">
			...
			<div class="content content-large">
				<?php echo Form::open(['route' => 'cms.quick_links.index']); ?>


				<?php echo $__env->make('cms.quick_links._form', ['submitButton' => "Save"], array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
