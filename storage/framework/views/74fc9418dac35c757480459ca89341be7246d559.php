<div class="content">
	...
	<div class="tabs-content">
		...
		<div class="content active" id="panel1">
			...
			<div class="row collapse">
				<div class="large-12 columns">
					<?php echo Form::label('file', 'Speech File in  swahili version'); ?>
		...
		<div class="content" id="panel2">
			...
			<div class="row collapse">
				<div class="large-12 columns">
					<?php echo Form::label('file_en', 'Speech File in  english version'); ?>
		...
		<div class="row collapse">
			<div class="large-12 columns">
				<?php echo Form::label('published_date', 'Speech Date'); ?>
