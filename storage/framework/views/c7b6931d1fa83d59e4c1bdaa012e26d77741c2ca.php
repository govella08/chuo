      ...
      <div class="content active" id="panel1">
      	...
      	<div class="row collapse">
			<div class="large-12 columns">
				...
				<?php echo Form::label('title', 'Quick Link title in in swahili'); ?>
      ...
      <div class="content" id="panel2">
        ...
        <div class="row collapse">
			<div class="large-12 columns">
				...
				<?php echo Form::label('title_en', 'Quick Link title in  english'); ?>
		...
		<div class="row collapse">
			...
			<div class="large-12 columns">
				...
				<?php echo Form::select('url', App\Models\Menu::selectMenu(), null, array('class' => 'internal')); ?>
