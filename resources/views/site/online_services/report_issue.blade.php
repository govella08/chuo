...
@section('title')
{!! __('label.report_issue',[],$currentLanguage->locale) !!}
@endsection
<!-- ./setting browser tab title -->
...
<li class="breadcrumb-item active">{!! __('label.report_issue',[],$currentLanguage->locale) !!}</li>
@endsection
...
<div class="form-group row">
	...
	<div class="form-group row">
		<label for="service" class="col-md-3 col-form-label">{!! __('label.service_type') !!}</label>

		<div class="col-md-9">
			{!! Form::select('service_type',$service_codes->pluck(($currentLanguage->locale=='en')?'service_name_en':'service_name_sw','service_code'),null,['id'=>'service','class'=>'form-control','placeholder'=>__('label.service_type_placeholder')]); !!}
		</div>
	</div>
