...
<div class="panel panel-default">
	<div class="panel-heading">
		<h4 class="panel-title"><i class="fa fa-thumb-tack" style="font-size:32px;"></i>&nbsp;Watersales Targets</h4>
	</div><br>
	<div class="row db-top-heading">
		<div class="col-md-6"></div>
		@permission('watersales_targets.create')
		<div class="col-md-6">
			<a class="btn btn-success btn-sm pull-right" href="{{ route('watersales_targets.create') }}"> <i class="fa fa-plus-square"></i> Create Region Targets</a>
		</div>
		@endpermission
	</div>
	...
	<div class="table-responsive">
		<table class="table table-bordered table table-sorting table-hover table-bordered table-dark-header  datatable  table-primary" id="watersales_target">
			<thead>
				<tr>
					<th>S/N</th>
					...
					<th>Region</th>
					<th>Indicator</th>
					 @if(Auth::user()->can(['watersales_targets.edit','watersales_targets.delete_watersales_targets']))
					<th>Action</th>
					@endif
				</tr>
			</thead>
...
$(document).ready(function() {
	var table = $('#watersales_target').DataTable( {
		"processing": true,
		"serverSide": true,
		"pageLength": 50,
		...
		"ajax": "{{ route('watersales_targets.index') }}",
		...
		<?php if(Auth::user()->can(['watersales_targets.edit','watersales_targets.delete_watersales_targets'])){ ?>
