...
<div class="panel panel-default">
	<div class="panel-heading">
		...
		<h4 class="panel-title"><i class="fa fa-sitemap" style="font-size:32px;"></i>&nbsp;New Connections</h4>
	</div><br>
	<div class="row db-top-heading">
		<div class="col-md-6"></div>
		@permission('newconnections.create')
		<div class="col-md-6">
			<a class="btn btn-success btn-sm pull-right" href="{{ route('newconnections.create') }}"> <i class="fa fa-plus-square"></i> Create New Connection</a>
		</div>
		@endpermission
	</div>
	...
	<div class="table-responsive">
		<table class="table table-bordered table table-sorting table-hover table-bordered table-dark-header  datatable  table-primary" id="newconections">
			<thead>
				<tr>
					<th>S/N</th>
					...
					<th>Applied</th>
					<th>Region</th>
					@if(Auth::user()->can(['newconnections.edit','newconnections.delete_newconnections']))
					<th>Action</th>
					@endif
				</tr>
			</thead>
...
$(document).ready(function() {
	var table = $('#newconections').DataTable( {
		"processing": true,
		"serverSide": true,
		"pageLength": 50,
		...
		"ajax": "{{ route('newconnections.index') }}",
		...
		<?php if(Auth::user()->can(['newconnections.edit','newconnections.delete_newconnections'])){ ?>
