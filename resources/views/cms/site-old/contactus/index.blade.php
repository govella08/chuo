                ...
                <div class="col-md-12">
                    ...
                    <div class="contact">
                        ...
                        <div class="row">
                            <div class="col-md-5">
                                <address>
                                    <h6>{{ label('lbl_site_title') }}.</h6>
                                    <i class="fa fa-map-marker"></i>  {{ label('lbl_address') }} {{ $contact->{langdb('physical_address')} }}<br>
                                    <span class="font-bold"><i class="fa fa-phone"></i> {{ label('lbl_hotline')}}:</span> {!! $contact->phone !!}<br>
                                    <span class="font-bold"><i class="fa fa-fax"></i> {{ label('lbl_fax')}}: N&#333;:</span> {!! $contact->fax !!}<br>
                                    <span class="font-bold"><i class="fa fa-globe"></i> {{ label('lbl_email') }}:</span> {!! $contact->email !!}<br>
                                </address>
                            </div>
                            ...
                            <div class="col-md-7">
                                <div>
                                    {!! Form::open(['route' => 'contactus.store', 'class'=> 'add_p']) !!}
                                        <legend>{!! label('lbl_feedback') !!}</legend>
                                        <div class="row">
                                            <div class="col-md-6 col-sm-6">
                                                {!! Form::text('names',null,['placeholder'=>'' ,'required', 'autocomplete' => 'off']) !!}
                                                <label for="names">{{ label('lbl_fullname')}}</label>
                                            </div>
                                            <div class="col-md-6 col-sm-6">
                                            ...
                                            <div class="col-md-12 col-sm-12">
                                               ...
                                               <label for="names">{{ label('lbl_phone')}}</label>
                                            </div>
                                            <!-- <div class="col-md-6 col-sm-6">
                                            ...
                                            <div class="col-md-12 col-sm-12 p-1">
                                                ...
                                                <label for="names">{{ label('lbl_subject')}}</label>
                                        ...
                                        <button type="submit" class="btn btn-success btn-raised pull-right"> {{ label('lbl_send') }}</button>
                                     {!! Form::close() !!}
                                </div>
                            </div>
                        </div>
...
@section('js-content')
    <script>
       ...
       var location_name = {lat: -6.8169177, lng: 39.2924413};
